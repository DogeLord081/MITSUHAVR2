...
namespace VRM
{
    ...
    {
        public GameObject LookAtCollider;
        private VRM.FOV fov_script;
        ...
        void Start()
        {
            ...
            LeftEye.Setup();
            RightEye.Setup();
            fov_script = LookAtCollider.GetComponent<FOV>();
        }
        ...
        {
            bool isTargetInCollider = fov_script.isTargetInCollider;
